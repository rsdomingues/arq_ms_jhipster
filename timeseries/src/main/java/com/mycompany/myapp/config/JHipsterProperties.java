...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "timeseries@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "timeseries API";

        private String description = "timeseries API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "timeseries";
